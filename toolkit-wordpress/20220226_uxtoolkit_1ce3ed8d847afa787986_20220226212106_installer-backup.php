...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20220226_uxtoolkit_1ce3ed8d847afa787986_20220226212106_archive.zip';
	const ARCHIVE_SIZE		 = '64011829';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '1ce3ed8-26212106';
    const SECONDARY_PACKAGE_HASH = 'c9726a8-26212106';
	const VERSION			 = '1.4.4';
